...
nocite: '@*'
---
\captionsetup[figure]{labelformat=default,labelsep=none,name=Figure}
...
## Key Findings
### Bike Preferences
Put yourself in the shoes of the average Cyclistic member. You may have a slight preference for electric bikes over classic bikes in regards to speed, but when it comes down to it, you just love the feeling of gliding down the road with the wind breezing by on a beautiful summer day. You enjoy riding Cyclistic's bikes because they provide you with the freedom to start and stop riding from wherever you're at to wherever you're going. This is exactly what electric and classic bikes do (and docked bikes don't). Taken together with the other key findings presented below, this is exactly what the data suggests about Cyclistic's annual members.**See Figures 1-3 (pg. 6-7).**

\begin{figure}[b]
\centering
\includegraphics[width=0.5\textwidth]{visualizations/bike_preferences20230825.png}
\caption{}
\end{figure}

\begin{figure}[b]
\centering
\includegraphics[width=0.5\textwidth]{visualizations/average_speed_customer20230825.png}
\caption{}
\end{figure}

\begin{figure}[b]
\centering
\includegraphics[width=0.5\textwidth]{visualizations/average_speed_ride_type20230825.png}
\caption{}
\end{figure}


### Ride Times, Duration, Frequency, and Distance
Our analysis shows that members feel less obligated to push a single trip to the limit because they've paid a flat rate. They bike more often and take shorter trips, as depicted by mean ride durations in green overlaying the graphs below. They are also more than three times as likely as casual riders to bike on a weekend when they have the free time away from work. **See Figures 4-7 (pg. 7-9).** 

\begin{figure}[b]
\centering
\includegraphics[width=0.5\textwidth]{visualizations/ride_lengths20230825.png}
\caption{}
\end{figure}
...
\begin{figure}[b]
\centering
\includegraphics[width=0.5\textwidth]{visualizations/ride_counts_by_day20230825.png}
\caption{}
\end{figure}
...
\begin{figure}[b]
\centering
\includegraphics[width=0.5\textwidth]{visualizations/start_times_members20230825.png}
\caption{}
\end{figure}
...
\begin{figure}[b]
\centering
\includegraphics[width=0.5\textwidth]{visualizations/starting_locations_spatial_clustering20230825.png}
\caption{}
\end{figure}
...
\begin{figure}[b]
\centering
\includegraphics[width=0.5\textwidth]{visualizations/top_10_popular_stations20230825.png}
\caption{}
\end{figure}
